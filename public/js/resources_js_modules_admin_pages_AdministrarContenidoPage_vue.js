        ...
        _c("div", { staticClass: "card-body py-5 px-4" }, [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.carousel_images,
                  expression: "carousel_images"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", placeholder: "Contraseña" },
              domProps: { value: _vm.carousel_images },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.carousel_images = $event.target.value
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "form-group mt-4" }, [
            ...
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "text", placeholder: "222 234 21 34" },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "form-group mt-4" }, [
      _c(
        "label",
        { staticClass: "text-primary", attrs: { for: "main_image" } },
        [
          _vm._v(
